const Navbar = () => {
        ...
        <div className="flex items-center justify-between w-full md:w-auto ml-20">
            ...
            <div className="-mr-2 flex items-center md:hidden">
                <button type="button" id="main-menu" aria-label="Main menu" aria-haspopup="true" className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
                    <svg stroke="currentColor" fill="none" viewBox="0 0 24 24" className="h-6 w-6"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
                </button>
            </div>
        </div>
    </div>
    <div className="hidden md:flex md:space-x-20">
        <a href="#features"
            className="font-medium text-lg dark:text-black-500 dark:hover:text-white transition duration-150 ease-in-out">Features</a>
        <a href="#pricing"
            className="font-medium text-lg dark:text-black-500 dark:hover:text-white transition duration-150 ease-in-out">Pricing</a>
        <a href="/blog"
            className="font-medium text-lg dark:text-black-500 dark:hover:text-white transition duration-150 ease-in-out">Blog</a>
        <a href="https://docs.pingping.io" target="_blank"
            className="font-medium text-lg dark:text-Black-500 dark:hover:text-white transition duration-150 ease-in-out">Docs</a>
    </div>
